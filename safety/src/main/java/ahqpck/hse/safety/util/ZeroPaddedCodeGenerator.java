...
public class ZeroPaddedCodeGenerator {
     ...
     *
     * @param entityClass The JPA entity class (e.g., Accident.class)
     * @param codeField   The name of the field representing the code (e.g., "code")
     * @param prefix      The prefix to filter by (e.g., "ACC", "INC")
     * @return Next code in format: {prefix}{6-digit number}, e.g., ACC000001
     */
