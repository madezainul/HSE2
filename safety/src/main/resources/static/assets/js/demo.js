...
// Jsvectormap - only initialize if library is loaded and element exists
...
//Chart
var statisticsChartElement = document.getElementById('statisticsChart');
if (statisticsChartElement) {
	var ctx = statisticsChartElement.getContext('2d');
...
var dailySalesChartElement = document.getElementById('dailySalesChart');
if (dailySalesChartElement) {
	var dailySalesChart = dailySalesChartElement.getContext('2d');
