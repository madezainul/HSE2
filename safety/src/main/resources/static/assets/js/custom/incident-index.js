/**
 * Incident Index Module
 * Provides common functionality for Incident pages including live search and filtering
 */

const IncidentIndexModule = {
    /**
        ...
        try {
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    window.IncidentIndexData[datalistId] = data.map(item => {
    ...
    setupFilterInput: function(config) {
        try {
            ...
            input.addEventListener('input', (e) => {
                ...
                if (!window.IncidentIndexData || !window.IncidentIndexData[datalistId]) {
                    return;
                }

                const allItems = window.IncidentIndexData[datalistId];
            ...
            input.addEventListener('focus', () => {
                if (window.IncidentIndexData && window.IncidentIndexData[datalistId]) {
                    const items = window.IncidentIndexData[datalistId];
...
console.log('IncidentIndexModule loaded successfully');
window.IncidentIndexModule = IncidentIndexModule;